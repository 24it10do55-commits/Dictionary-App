               ...
               📖 Dictionary App
                ...
                <div className="flex gap-3">
                    <input type="text"
                     ...
                     className="flex-1 border-2 border-indigo-300 rounded-xl px-4 py-3 outline-none
                     focus:border-indigo-600 "
                     value={word}
                     onChange={(e) =>setWord(e.target.value)}
                     />
                    <button className="bg-indigo-600  px-10 text-white font-medium text-lg rounded-xl  hover:bg-indigo-700 cursor-pointer " onClick={searchWord}>Search</button>

                </div>
                {loading && (
                    <h2 className="text-center mt-6 text-lg text-indigo-400 font-semibold
                    animate-pulse">
                        Searching...
                    </h2>
                )}
                    ...
                    <div className="mt-8 bg-indigo-50 rounded-2xl p-6">
                        ...
                        <div className="mt-5 space-y-3">
                            ...
                            <div className="bg-white/70 rounded xl p-3">
                                ...
                                <p>{wordData.meanings[0].definitions[0].example ||  "No Example found"}
